...
const MobileNav = () => {
  ...
  return (
    <>
      <button aria-label="Toggle Menu" onClick={onToggleNav} className="focus-ring sm:hidden">
        <svg
      ...
      >
        <div className="flex justify-end">
          <button
            className="focus-ring mt-11 mr-8 h-8 w-8"
...
function MobileNavItem({ link, pathname, onToggleNav }) {
  ...
  return (
    <div className="px-12 py-4">
      <Link
        ...
        onClick={onToggleNav}
      >
        <AnimatedBackground isHovered={isHovered || isActive} stroke="#3b82f6" opacity="0.2" />
