...
export default function FlowChartBackground({
  ...
  const yellow300 = '#E8EE73'
  const yellow400 = '#DCE94B'
  const yellow500 = '#CEE424'
  const yellow600 = '#A3BB1E'
  const highlightColor = 'rgb(50,64,7)'
  const animationColor = '#33400A'
  ...
  return (
    ...
    >
      <g transform="matrix(1,0,0,1,-1485.93,-1960.35)">
        <g id="Artboard2" transform="matrix(1.96071,0,0,2.14548,-2358.02,1960.35)">
          <rect x="1960.48" y="0" width="1910.48" height="800" style={{ fill: 'none' }} />
          <clipPath id="_clip1">
            <rect x="1960.48" y="0" width="1910.48" height="800" />
          </clipPath>
          <g clipPath="url(#_clip1)">
            <g transform="matrix(0.0666289,0,0,0.142496,3744.75,-8690.43)">
              <motion.path
                ...
                style={{ fill: 'none', stroke: yellow300, strokeWidth: strokeWidth * 35.45 }}
                animate={{ opacity: [0.5, 0.6] }}
                transition={{
                  duration: 8,
                  repeat: Infinity,
                  repeatType: 'reverse',
            ...
            <g transform="matrix(0.0666289,0,0,0.142496,3978.86,-8690.43)">
              <motion.path
                ...
                style={{ fill: 'none', stroke: yellow400, strokeWidth: strokeWidth * 35.45 }}
            ...
            <g transform="matrix(0.0666289,0,0,0.142496,4282.97,-8869.63)">
              <motion.path
                ...
                style={{ fill: 'none', stroke: yellow500, strokeWidth: strokeWidth * 35.45 }}
            ...
            <g transform="matrix(0.0666289,0,0,-0.142496,4214.78,9549.23)">
              <motion.path
            ...
            <g transform="matrix(0.0666289,0,0,0.142496,4192.78,-8690.43)">
              <motion.path
            ...
            <g transform="matrix(0.0666289,0,0,-0.142496,3884.28,9727.99)">
              <motion.path
            ...
            <g transform="matrix(0.0666289,0,0,-0.142496,4088.34,9727.99)">
              <motion.path
            ...
            <g transform="matrix(0.0666289,0,0,-0.142496,3814.34,9727.99)">
              <motion.path
            ...
            <g transform="matrix(0.0666289,0,0,-0.142496,3742.97,9727.99)">
              <motion.path
            ...
            <g transform="matrix(0.0666289,0,0,-0.142496,4167.97,9878.18)">
              <motion.path
            ...
            <g transform="matrix(0.0666289,0,0,0.142496,4340.66,-8540.52)">
              <motion.path
            ...
            <g transform="matrix(0.0114124,0.0104296,-0.0114124,0.0104296,4381.57,-209.017)">
              <rect
                x="-7523.11"
                y="59424.4"
                width="764.448"
            ...
            <g transform="matrix(0.0114124,0.0104296,-0.0114124,0.0104296,4351.11,-269.483)">
              <motion.rect
                x="-7523.11"
                y="59424.4"
                width="764.448"
                height="764.448"
                style={{ fill: 'none', stroke: yellow300, strokeWidth: strokeWidth * 263.34 }}
                animate={{ opacity: [0.5, 1.0] }}
                transition={{
                  duration: 10,
                  repeat: Infinity,
            ...
            <g transform="matrix(0.0114124,0.0104296,-0.0114124,0.0104296,4374.33,-269.483)">
              <motion.rect
                x="-7523.11"
                y="59424.4"
                width="764.448"
                height="764.448"
                style={{ fill: 'none', stroke: yellow500, strokeWidth: strokeWidth * 263.34 }}
                animate={{ opacity: [0.5, 0.6] }}
                transition={{
                  duration: 7,
                  repeat: Infinity,
            ...
            <g transform="matrix(0.0114124,0.0104296,-0.0114124,0.0104296,4397.1,-269.483)">
              <motion.rect
                x="-7523.11"
                y="59424.4"
                width="764.448"
                height="764.448"
                style={{ fill: 'none', stroke: yellow600, strokeWidth: strokeWidth * 263.34 }}
                animate={{ opacity: [0.5, 0.85] }}
                transition={{
                  duration: 12,
                  repeat: Infinity,
            ...
            <g transform="matrix(0.0114124,0.0104296,-0.0114124,0.0104296,4483.3,73.7621)">
              <motion.rect
                x="-7523.11"
                y="59424.4"
                width="764.448"
            ...
            <g transform="matrix(0.0114124,0.0104296,-0.0114124,0.0104296,4576.56,119.345)">
              <motion.rect
                x="-7523.11"
                y="59424.4"
                width="764.448"
            ...
            <g transform="matrix(0.0114124,0.0104296,-0.0114124,0.0104296,4597.65,119.345)">
              <motion.rect
                x="-7523.11"
                y="59424.4"
                width="764.448"
