  ...
  return (
    ...
    >
      ...
      <article className="relative z-10 flex flex-col">
        ...
        <div className="prose max-w-none text-base leading-5 text-blue-800/80 group-hover:text-blue-800 sm:text-lg sm:leading-6">
          {summary}
        </div>
        <time
          className="text-sm leading-12 font-medium text-blue-900 transition duration-300 group-hover:text-blue-900 sm:text-base"
          dateTime={date}
        >
