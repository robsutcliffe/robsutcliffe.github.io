...
export default function Hero() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative h-[calc(100vh-0.002rem)] min-h-[700px] min-w-[420px] overflow-hidden bg-yellow-100 p-2 pb-0 md:h-[calc(100vh-0.005rem)] md:p-4 md:pb-0 lg:h-[calc(100vh-1.5rem)] lg:p-6 lg:pb-0"
    >
